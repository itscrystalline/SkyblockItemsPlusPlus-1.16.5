...
public class Silver_Fang extends TaggedSwordItem {
    ...
    public Silver_Fang(IItemTier itemTier, int damage, float attackSpeed, Properties properties, CustomRarity rarity) {
