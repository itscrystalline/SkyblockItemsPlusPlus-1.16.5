...
public class Refined_Netherite_Leggings extends ArmorItem {
    public Refined_Netherite_Leggings(IArmorMaterial armorMaterial, EquipmentSlotType slotType, Item.Properties properties) {
        super(armorMaterial, slotType, properties);
    }

    @Override
    public void appendHoverText(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        tooltip.add(new StringTextComponent("\u00A77" + "Defense: " + ColorText.GREEN + "+70"));
        ...
        tooltip.add(new StringTextComponent(  ColorText.GOLD + "\u00A7l" +"LEGENDARY LEGGINGS"));
