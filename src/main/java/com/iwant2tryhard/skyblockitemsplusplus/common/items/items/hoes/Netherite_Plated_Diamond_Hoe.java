...
public class Netherite_Plated_Diamond_Hoe extends HoeItem {
    ...
    public Netherite_Plated_Diamond_Hoe(IItemTier itemTier, int damage, float attackSpeed, Properties properties, CustomRarity rarity) {
    ...
    public void appendHoverText(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(new StringTextComponent(rarity + "HOE"));
