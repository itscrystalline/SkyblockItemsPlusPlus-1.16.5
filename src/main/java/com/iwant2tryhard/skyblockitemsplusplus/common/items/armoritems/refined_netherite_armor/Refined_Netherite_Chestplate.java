...
public class Refined_Netherite_Chestplate extends ArmorItem {
    public Refined_Netherite_Chestplate(IArmorMaterial armorMaterial, EquipmentSlotType slotType, Item.Properties properties) {
        super(armorMaterial, slotType, properties);
    }

    @Override
    public void appendHoverText(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
        tooltip.add(new StringTextComponent("\u00A77" + "Defense: " + ColorText.GREEN + "+100"));
