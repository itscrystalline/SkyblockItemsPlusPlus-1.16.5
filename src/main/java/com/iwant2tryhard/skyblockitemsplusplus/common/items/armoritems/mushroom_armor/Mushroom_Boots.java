...
public class Mushroom_Boots extends ArmorItem {
    private final CustomRarity rarity;
    private static int statMultiplier = 1;
    private static int hp = 3;

    public Mushroom_Boots(IArmorMaterial armorMaterial, EquipmentSlotType slotType, Properties properties, CustomRarity rarity) {
